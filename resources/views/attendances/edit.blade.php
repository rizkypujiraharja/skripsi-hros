                ...
                <form class="form" action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('nip', $user->nip) }}" name="nip" class="@error('nip') is-invalid @enderror form-control">
                            @error('nip')
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('name', $user->name) }}" name="name" class="@error('name') is-invalid @enderror form-control">
                            @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('ktp', $user->ktp) }}" name="ktp" class="@error('ktp') is-invalid @enderror form-control">
                            @error('ktp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('npwp', $user->npwp) }}" name="npwp" class="@error('npwp') is-invalid @enderror form-control">
                            @error('npwp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="date" value="{{ old('birth_date', $user->birth_date) }}" name="birth_date" class="@error('birth_date') is-invalid @enderror form-control">
                            @error('birth_date')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('position', $user->position) }}" name="position" class="@error('position') is-invalid @enderror form-control">
                            @error('position')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="text" value="{{ old('sallary', $user->sallary) }}" name="sallary" class="@error('sallary') is-invalid @enderror form-control">
                            @error('sallary')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="date" value="{{ old('joined_at', $user->joined_at) }}" name="joined_at" class="@error('joined_at') is-invalid @enderror form-control">
                            @error('joined_at')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-6 col-md-9 col-lg-6">
                            <input type="date" value="{{ old('contract_until', $user->contract_until) }}" name="contract_until" class="@error('contract_until') is-invalid @enderror form-control">
